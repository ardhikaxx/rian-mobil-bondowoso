            ...
            <div className="relative bg-gradient-to-br from-gray-900 to-black rounded-3xl overflow-hidden shadow-2xl border border-gray-800">
              <div className="aspect-[4/3] flex items-center justify-center">
                <div className="text-center space-y-4 p-8">
                  <div className="w-24 h-24 mx-auto bg-gray-900 rounded-3xl flex items-center justify-center border border-gray-700">
                    <Icon name="car" size={56} className="text-gray-600 opacity-60" />
                  </div>
                  <p className="text-gray-400 text-sm font-medium">Placeholder untuk foto lokasi atau showroom</p>
                  <p className="text-gray-600 text-xs">Ganti dengan foto asli Rian Mobil Bondowoso</p>
                </div>
              </div>
            </div>
